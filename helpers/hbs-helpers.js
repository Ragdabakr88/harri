  ...
  select: function(selected, options){
    ...
    paginate: function(options){
        ...
        if(options.hash.current === 1){
            output += `<li class="page-item disabled"><a class="page-link">الاول </a></li>`;
        } else {
            output += `<li class="page-item"><a href="?page=1" class="page-link">الاول </a></li>`;
        }
        ...
        for(; i <= (Number(options.hash.current) + 4) && i <= options.hash.pages; i++){
         ...
         if(options.hash.current === options.hash.pages) {
             ...
             output += `<li class="page-item disabled"><a class="page-link">الاخير </a></li>`;
